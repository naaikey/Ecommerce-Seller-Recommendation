...
def main():
    ...
    spark = get_spark_session(app_name="ETL_Company_Sales")
    paths = config['company_sales']
    ...
    print(f"Starting ETL for Company Sales...")
    ...
    cleaned_df = cleaned_df.withColumn("item_id", trim(col("item_id")))
    cleaned_df = (
        cleaned_df
    ...
    cleaned_df = cleaned_df.fillna(0, subset=["units_sold", "revenue"])
